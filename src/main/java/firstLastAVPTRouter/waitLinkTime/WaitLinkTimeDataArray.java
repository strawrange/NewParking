...
public class WaitLinkTimeDataArray implements WaitLinkTimeData {
	...
	//Constructors
	public WaitLinkTimeDataArray(int numSlots) {
	...
	//Methods
	@Override
	public void resetWaitLinkTimes() {
	...
	@Override
	public synchronized void addWaitLinkTime(int timeSlot, double waitTime) {
		waitTimes[timeSlot] = (waitTimes[timeSlot]*numTimes[timeSlot]+waitTime)/++numTimes[timeSlot];
	}
	@Override
	public double getWaitLinkTime(int timeSlot) {
