...
//	private final QNetwork qnetwork ;
	...
	AbstractQLink(Link link, QNodeI toNode, NetsimEngineContext context, QNetsimEngine.NetsimInternalInterface netsimEngine2, LinkSpeedCalculator linkSpeedCalculator) {
		this.link = link ;
		this.toQNode = toNode ;
