...
public class VehicleEnlarge {
    ...
    public static void main(String[] args) {
        ...
        copy(mediumV, numM);
        copy(largeV, numL);
        new VehicleWriter(newFleet.getVehicles().values()).write("/home/biyu/Dropbox (engaging_mobility)/TanjongPagar/scenarios/tanjong_pagar/drtvehicles/drtvehicles_" + num + ".xml");
    }
