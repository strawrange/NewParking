...
class QueueingAndDwellingCounter implements IndicatorModule, VehicleArrivesAtFacilityEventHandler, VehicleDepartsAtFacilityEventHandler, PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler, ActivityStartEventHandler, ActivityEndEventHandler{
    ...
    String filename = "queueingAndDwellingTimeAnalysis.csv";
