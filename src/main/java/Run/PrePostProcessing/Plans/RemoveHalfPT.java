...
public class RemoveHalfPT {
    public static void main(String[] args) {
        ...
        new PopulationWriter(population).write("/home/biyu/Dropbox (engaging_mobility)/TanjongPagar/scenarios/tanjong_pagar/plans/tp_plans_1_0.125_taxi.xml.gz");
    }
}
