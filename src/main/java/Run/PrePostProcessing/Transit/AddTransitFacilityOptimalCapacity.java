...
public class AddTransitFacilityOptimalCapacity {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = IOUtils.getBufferedReader("/home/biyu/IdeaProjects/matsim-spatialDRT/output/optimal_bay.csv");
        br.readLine();
